	...
	<div class="wrapper">
		<div class="content-wrapper">
			...
			<section class="content-header">
		      <h1>
		        <?= $this->lang->line('site_common/create')." ".$this->lang->line('site_common/new')." ".$this->lang->line('site_common/item');?>
		        <!-- <small>Preview</small> -->
		      </h1>
		      <ol class="breadcrumb">
		        <li><a href="#"><i class="fa fa-dashboard"></i> <?=$this->lang->line('sidebar_vendor/dashboard');?></a></li>
		        <li><a href="<?=site_url('vendor/item');?>"><i class="fa fa-gift"></i> <?=$this->lang->line('sidebar_vendor/items');?></a></li>
		      ...
		      <div class="row">
		        ...
		        <div class="col-md-8">
		          ...
		          <div class="box box-warning">
		          	<form role="form" action="<?= site_url('vendor/item/create_item'); ?>" method="post">
		            <div class="box-header with-border">
		              <h3 class="box-title"><?=$this->lang->line('site_common/item')."&nbsp;".$this->lang->line('site_common/create');?></h3>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
		                ...
		                <div class="form-group <?= form_error('itemOfferPrice') ? 'has-error' : '' ?>">
		                  <label class="control-label" for="item_offer_price"><?=$this->lang->line('itemcreate_vendor/label_offer_price');?></label>
		                  <input type="text" class="form-control" name="itemOfferPrice" id="item_offer_price" placeholder="<?=$this->lang->line('itemcreate_vendor/offer_price_placeholder');?>" value="<?php echo set_value('itemOfferPrice'); ?>">
		                  <span class="help-block"><?= form_error('itemOfferPrice'); ?></span>
		                </div>

		                <div class="form-group <?= form_error('itemOfferExpiryDate') ? 'has-error' : '' ?>">
			                <label><?=$this->lang->line('itemcreate_vendor/label_offer_exp_date');?></label>
