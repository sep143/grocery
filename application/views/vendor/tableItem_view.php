		...
		<div class="content-wrapper">
			...
			<section class="content-header">
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active"><i class="fa fa-gift"></i> <?=$this->lang->line('sidebar_vendor/items');?></li>
		      </ol>
		    </section>
		        	...
		        	<div class="col-xs-12">
		        		<div class="box">
				            <div class="box-header">
				              ...
				              <a class="btn btn-success" href="<?=site_url('vendor/item/create');?>"><i class="fa fa-plus"></i> <?=$this->lang->line('site_common/add')." ".$this->lang->line('site_common/item');?></a>
				            </div>
				            <!-- /.box-header -->
				            <div class="box-body">
				              	<table id="itemListTable" class="table table-bordered table-striped">
					                ...
					                <tbody>
						                <tr>
						                  ...
						                  <td>
						                  	<a class="btn btn-app" href="<?=site_url('vendor/item/edit');?>"><i class="fa fa-edit"></i> Edit</a>
