	...
	<div class="wrapper">
		<div class="content-wrapper">
			...
			<section class="content-header">
		      <h1>
		        <?= $this->lang->line('site_common/create')." ".$this->lang->line('site_common/new')." ".$this->lang->line('sidebar_admin/delivery_boy');?>
		        <!-- <small>Preview</small> -->
		      </h1>
		      <ol class="breadcrumb">
		        ...
		        <li class="active"><?=$this->lang->line('site_common/create')." ".$this->lang->line('sidebar_admin/delivery_boy');?></li>
		      </ol>
		    </section>
		    <!-- Main content -->
		      ...
		      <div class="row">
		        ...
		        <div class="col-md-8">
		          ...
		          <div class="box box-warning">
		          	<form role="form" action="<?= site_url('admin/delivery_boy/create_delivery_boy'); ?>" method="post">
		            <div class="box-header with-border">
		              <h3 class="box-title"><?=$this->lang->line('sidebar_admin/delivery_boy')."&nbsp;".$this->lang->line('site_common/create');?></h3>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
