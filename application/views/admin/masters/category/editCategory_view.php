	...
	<div class="wrapper">
		<div class="content-wrapper">
			...
			<section class="content-header">
		      <h1>
		        <?= $this->lang->line('site_common/edit')." ".$this->lang->line('sidebar_admin/category')." / ".$this->lang->line('sidebar_admin/sub_category');?>
		        <!-- <small>Preview</small> -->
		      </h1>
		      <ol class="breadcrumb">
		        ...
		        <li class="active"><?=$this->lang->line('sidebar_admin/category')." ".$this->lang->line('site_common/edit');?></li>
		      </ol>
		    </section>
		    <!-- Main content -->
		        ...
		        <div class="col-md-8">
		          ...
		          <div class="box box-warning">
		            ...
		            <div class="box-header with-border">
		              <h3 class="box-title"><?=$this->lang->line('sidebar_admin/category')."&nbsp;".$this->lang->line('site_common/edit');?></h3>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
