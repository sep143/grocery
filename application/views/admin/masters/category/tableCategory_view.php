	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
		      <h1>
		        <?= $this->lang->line('sidebar_admin/category')." ".$this->lang->line('site_common/list');?>
		        <!-- <small>Preview</small> -->
		      </h1>
		      <ol class="breadcrumb">
		        	...
		        	<div class="col-xs-12">
		        		<div class="box">
				            <div class="box-header">
				              ...
				              <a class="btn btn-success" href="<?=site_url('admin/category/create');?>"><i class="fa fa-plus"></i> <?=$this->lang->line('site_common/add')." ".$this->lang->line('sidebar_admin/category');?></a>
				            </div>
				            <!-- /.box-header -->
				            <div class="box-body">
				              	<table id="itemListTable" class="table table-bordered table-striped">
					                <thead>
						                <tr>
											...
											<th><?=$this->lang->line('sidebar_admin/category')." ".$this->lang->line('site_common/name');?></th>
											<th><?=$this->lang->line('site_common/category')." ".$this->lang->line('site_common/name');?></th>
