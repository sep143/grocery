	...
	<div class="wrapper">
		<div class="content-wrapper">
			...
			<section class="content-header">
		      <h1>
		        <?= $this->lang->line('site_common/create')." ".$this->lang->line('site_common/new')." ".$this->lang->line('sidebar_admin/category')." / ".$this->lang->line('sidebar_admin/sub_category');?>
		        <!-- <small>Preview</small> -->
		      </h1>
		      <ol class="breadcrumb">
		        ...
		        <li class="active"><?=$this->lang->line('sidebar_admin/category')." ".$this->lang->line('site_common/create');?></li>
		      </ol>
		    </section>
		    <!-- Main content -->
		      ...
		      <div class="row">
		        ...
		        <div class="col-md-8">
		          ...
		          <div class="box box-warning">
		          	<form role="form" action="<?= site_url('admin/category/create_category'); ?>" method="post">
		            <div class="box-header with-border">
		              <h3 class="box-title"><?=$this->lang->line('sidebar_admin/category')."&nbsp;".$this->lang->line('site_common/create');?></h3>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
		                <div class="form-group <?= form_error('categoryID') ? 'has-error' : '' ?>">
		                  <label for="category_id"><?=$this->lang->line('site_common/category')."&nbsp;".$this->lang->line('site_common/id');?> </label>
		                  <select class="form-control" name="categoryID" id="category_id">
		                  	<option value=""><?=$this->lang->line('masters_admin/select_category');?></option>
		                  ...
		                  <span class="help-block"><?= form_error('categoryID');?></span>
		                </div>
		                <!-- text input -->
