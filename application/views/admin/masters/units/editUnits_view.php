	...
	<div class="wrapper">
		<div class="content-wrapper">
			...
			<section class="content-header">
		      <h1>
		        <?= $this->lang->line('site_common/edit')." ".$this->lang->line('site_common/new')." ".$this->lang->line('site_common/unit');?>
		        <!-- <small>Preview</small> -->
		      </h1>
		      <ol class="breadcrumb">
		        ...
		        <li class="active"><?=$this->lang->line('site_common/unit')." ".$this->lang->line('site_common/edit');?></li>
		      </ol>
		    </section>
		    <!-- Main content -->
		      ...
		      <div class="row">
		        ...
		        <div class="col-md-8">
		          ...
		          <div class="box box-warning">
		          	<form role="form" action="<?= site_url('admin/units/edit_unit'); ?>" method="post">
		            <div class="box-header with-border">
		              <h3 class="box-title"><?=$this->lang->line('sidebar_admin/unit')."&nbsp;".$this->lang->line('site_common/edit');?></h3>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
		                <!-- text input -->
