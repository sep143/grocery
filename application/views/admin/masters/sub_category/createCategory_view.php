	...
	<div class="wrapper">
		<div class="content-wrapper">
			...
			<section class="content-header">
		      <h1>
		        <?= $this->lang->line('site_common/create')." ".$this->lang->line('site_common/new')." ".$this->lang->line('site_common/category');?>
		        <!-- <small>Preview</small> -->
		      </h1>
		      <ol class="breadcrumb">
		        ...
		        <div class="col-md-8">
		          ...
		          <div class="box box-warning">
		            ...
		            <div class="box-header with-border">
		              <h3 class="box-title"><?=$this->lang->line('site_common/category')."&nbsp;".$this->lang->line('site_common/create');?></h3>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
		                <!-- text input -->
