		        ...
		        <div class="col-md-8">
		          ...
		          <div class="box box-warning">
		            ...
		            <div class="box-body">
		                ...
		                <div class="row">
		                	<div class="col-md-4">
				                <div class="form-group <?= form_error('prifilePic') ? 'has-error' : '' ?>">
				                  	<label for="profile_pic"><?=$this->lang->line('vendor_admin/profile_pic_label');?></label>
				                 	<input type="file" name="prifilePic" id="profile_pic">

				                  	<span class="help-block"><?= form_error('prifilePic')?></span>
				                </div>
				            </div>
				            <div class="col-md-4">
				                <div class="form-group <?= form_error('prifileCoverPic') ? 'has-error' : '' ?>">
				                  	<label for="profile_cover_pic"><?=$this->lang->line('vendor_admin/profile_cover_pic_label');?></label>
				                 	<input type="file" name="prifileCoverPic" id="profile_cover_pic">
				                  	<span class="help-block"><?= form_error('prifileCoverPic')?></span>
				                </div>
				            </div>    
		            	</div>
